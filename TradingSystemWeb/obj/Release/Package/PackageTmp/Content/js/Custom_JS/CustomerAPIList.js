...
var Back = function () {
    window.location.href = '/Customer/CustomerAPIDetail';
}
...
var columnDefs = [
    ...
    { headerName: "Created Date", field: "dCreationDate", width: 135, sortable: true },
    ...
    { headerName: "Export Type", field: "ExportType", tooltip: function (params) { return (params.value); }, width: 95, cellRenderer: ExportType, sortable: false },
    { headerName: "API Name", field: "APIName", width: 130, sortable: true },
    { headerName: "API Url", field: "APIUrl", width: 500, sortable: false },
    { headerName: "Active", field: "APIStatus", sortable: true, tooltip: function (params) { return (params.value); }, width: 58, cellRenderer: Status, },
    { headerName: "Last Updated", field: "dTransDate", width: 130, sortable: true },
...
function ExportType(params) {
    ...
    else if (params.data.ApiMethod == "Location") {
        return params.data.LocationExportType;
    }
}
...
function EditData(row) {
    location.href = '/Customer/CustomerAPIDetail?TransId=' + row;
}

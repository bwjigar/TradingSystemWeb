...
namespace MainWebsite.DataAccess
{
    ...
    public partial class STOCK
    {
        ...
        public Nullable<byte> SHAPE_SEQ { get; set; }
        public Nullable<decimal> CTS { get; set; }
        public Nullable<byte> COLOR_SEQ { get; set; }
        public Nullable<byte> PURITY_SEQ { get; set; }
        public Nullable<byte> CUT_SEQ { get; set; }
        public Nullable<byte> POLISH_SEQ { get; set; }
        public Nullable<byte> SYMM_SEQ { get; set; }
        public Nullable<byte> FLS_SEQ { get; set; }
        public string FLS_COLOR { get; set; }
        public Nullable<byte> LAB_SEQ { get; set; }

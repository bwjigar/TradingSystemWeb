...
var columnDefs = [
    ...
    {
        headerName: $("#hdn_View_Image").val(), tooltip: function (params) { return (params.value); }, field: "ImagesLink", width: 90, cellRenderer: ImageValueGetter, suppressSorting: true,
        suppressMenu: true,
    },
    {
